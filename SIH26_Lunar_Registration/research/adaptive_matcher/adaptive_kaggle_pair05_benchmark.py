...
GEO_FILE = KAGGLE_ROOT / "pair05_actual_geo_matches.csv"

FINAL_PROTOCOL = (
    KAGGLE_ROOT / "pair05_FINAL_validation_protocol.csv"
)

CALIBRATION_FILE = (
    KAGGLE_ROOT / "pair05_translation_calibration.json"
)
...
print("==============================================")
print("KAGGLE PAIR 05 — ADAPTIVE BENCHMARK")
print("==============================================")
...
output = (
    KAGGLE_ROOT
    / "kaggle_pair05_adaptive_results.csv"
)
