...
# ============================================================
# STAGE 2 — LOCAL GEO TILE CANDIDATES
# ============================================================
...
# Pair 01 coordinate convention:
#
#   A_x = short horizontal dimension: 0 ... ~1200
#   A_y = long vertical dimension:    0 ... ~10106
#
# Therefore a 600x600 tile uses:
#   x-ranges along 0...1200
#   y-ranges along 0...10106
#
# These are the source regions from the previously
# successful Pair 01 geoguided 8-tile experiment.
...
for ax0, ax1 in A_X_RANGES:

    for ay0, ay1 in A_Y_RANGES:

        tile_id += 1

        # ----------------------------------------------------
        # Local geographic support for THIS A tile.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # Place B tile using LOCAL geographic correspondences.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # Count current global LoFTR evidence in this A tile.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # Refinement priority:
        # more geographic support +
        # less current visual evidence.
        # ----------------------------------------------------
